...
import { assinarETransmitirNFeHomologacao, gerarRascunhoXmlNFe, liberarNumeracaoNFeRejeitada, registrarNumeracaoNFeAutorizada, validarPreEmissaoNFe } from '../../services/nfePreflightService'
  ...
  async function emitirNotaFiscal() {
    ...
    try {
      ...
      if (homologacao.autorizada) {
        ...
        await liberarNumeracaoNFeRejeitada(
